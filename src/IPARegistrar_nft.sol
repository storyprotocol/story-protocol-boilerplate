...
import { IStoryProtocolGateway } from "@story-protocol/periphery/interfaces/IStoryProtocolGateway.sol"; //solved
import { IPAssetRegistry } from "@story-protocol/core/registries/IPAssetRegistry.sol";//solved
import { SPG } from "@story-protocol/periphery/contracts/lib/SPG.sol";//solved
import { Metadata } from ""@story-protocol/periphery/contracts/lib/Metadata.sol";//solved
